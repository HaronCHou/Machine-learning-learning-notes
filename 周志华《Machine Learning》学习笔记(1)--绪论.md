 ...
 **1.3 归纳偏好**
 ...
 学习算法在学习过程中对某种假设的偏好——**归纳偏好**，任何一个有效的算法必须有其归纳偏好。
 有没有一般性的原则引导算法确立“正确”的偏好呢？
 - “奥卡姆剪刀”Occam's razor——若多个假设与观察一致，则选择最简单的那个！“简单”==“平滑”
 - 归纳偏好对应着——什么样的模型是最好的？
 - **没有免费的午餐NFL**定理：无论是哪个学习算法，总误差与学习算法无关
 - 但是NFL定理的前提是：所有问题出现的机会相同、或所有问题同等重要！即假设了f的均匀分布！实际上肯定不是这样的！
 - NFL的寓意是：脱离具体问题，空泛地谈论“什么学习算法更好”没有意义。关键是学习算法自身的归纳偏好是否与问题匹配更重要，谈论算法的优劣必须要针对具体的问题
